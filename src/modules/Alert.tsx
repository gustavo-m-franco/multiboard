...
export const Alert: React.FC<AlertProps> = ({ show, showProgress, title, message, showCancelButton, showConfirmButton, confirmText, onConfirmPressed, onCancelPressed, cancelText }) => (
  <AwesomeAlert
    show={ show }

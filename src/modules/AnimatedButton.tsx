...
export default class AnimatedButton extends React.PureComponent<AnimatedButtonProps, AnimatedButtonState> {
  ...
  render() {
    ...
    return (
      <Animated.View style={ [styles.animationContainer, { width, transform: [{ scale: animation, }, { perspective: 1000, },], opacity: animation, }] }>
        <TouchableOpacity
